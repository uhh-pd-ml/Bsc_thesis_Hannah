...
#LAYERS = [9, 6, 4, 2, 4, 6, 9]

# Feature Selection
#useful_indices = [0,1,3,5,6,9,11,18,22]
...
with h5py.File('/beegfs/u/bbd1146/daten_26F/events_b_sr.h5', 'r') as f:
    kin_b_sr = f['jet_kinematics'][:958]
    jet_b_sr = f['jettiness'][:958]
# Signal in Signal Region
with h5py.File('/beegfs/u/bbd1146/daten_26F/events_s_sr.h5', 'r') as f:
    kin_s_sr = f['jet_kinematics'][:958]
    jet_s_sr = f['jettiness'][:958]
